    ...
    public class CalisanController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if(yetkiTurId == 2)
            {
                ...
                var isler = (from i in entitiy.Isler where i.isPersonelId == personelId && i.isOkunma==false
        ...
        {
            var tekIs = (from i in entitiy.Isler where i.isId == isId select i).FirstOrDefault();
        ...
        public ActionResult Yap()
        {
            ...
            {
                int personelId = Convert.ToInt32(Session["PersonelId"]);
                var isler = (from i in entitiy.Isler
        ...
        public ActionResult Yap(int isId, string isYorum)
        {
            ...
            //yapılan tarihi sadece taih olarak alıyor saat bilgini almıyor
        ...
        public ActionResult Takip()
        {
            ...
            if (yetkiTurId == 2)
            {
                int personelId = Convert.ToInt32(Session["PersonelId"]);
                var isler = (from i in entitiy.Isler
                             join d in entitiy.Durumlar on i.isDurumId equals d.durumId
